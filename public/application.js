/*
1. Opens a database
2. Synchronises with the /stories, adding stories that have been added and deleting stories
   that have been removed
3. Uses window.templates.list() and window.templates.article() to render those articles.
4. Uses history.pushState to update the URL when a user clicks on an article or when they 
   click to view list of articles and refreshes the content on screen with that of the requested page.
*/
